export function CtaSection() {
  return (
    <section className="py-30 bg-deep-charcoal text-center max-md:py-20" id="contact">
      <div className="max-w-[700px] mx-auto px-15 max-md:px-6">
        ...
        <a
          ...
          className="inline-block font-body text-sm font-medium no-underline tracking-[0.02em] px-8 py-4 bg-beige text-deep-charcoal hover:bg-[#CFC5B8] transition-all"
        >
