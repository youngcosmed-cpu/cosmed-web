        ...
        <div className="flex-1 overflow-y-auto px-7 py-5">
          ...
          <div className="flex gap-2.5 mb-6">
            ...
            <input
              ...
              onKeyDown={(e) => e.key === 'Enter' && handleCreate()}
              placeholder="순서"
              className="w-[72px] px-3 py-2.5 border border-border-strong rounded-lg font-body text-sm text-admin-dark text-center outline-none focus:border-admin-dark transition-colors placeholder:text-text-disabled"
            />
            <button
              ...
              editingId === cat.id ? (
                ...
                >
                  ...
                  <input
                    ...
                    className="w-[72px] px-3 py-2 border border-border-strong rounded-lg font-body text-sm text-admin-dark text-center outline-none focus:border-admin-dark transition-colors"
                  />
                  <button
                ...
                <div
                  key={cat.id}
                  className="flex items-center gap-3 py-2.5 px-3 rounded-lg hover:bg-bg-admin group transition-colors"
                >
                  <span className="flex-1 font-body text-sm text-admin-dark">
                    {cat.name}
                  </span>
                  <span className="font-body text-xs text-text-placeholder w-8 text-center">
                    {cat.sortOrder}
                  </span>
                  <button
